...
pmcconfigure(void)
{
	...
	if(memcmp(m->cpuidid, "AuthenticAMD", 12) == 0){
		isrecog++;
	...
	}else if(memcmp(m->cpuidid, "GenuineIntel", 12) == 0){
		isrecog++;
